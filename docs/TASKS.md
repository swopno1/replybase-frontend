...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| T001 | HIGH | PENDING | UI/UX | Hardcoded color tokens | Design inconsistency | Transition to Tailwind 4 theme variables |
...
| T004 | MEDIUM | PENDING | TECH | Existing linting errors | Code quality/Build stability | Fix unescaped entities and unused vars in docs and about pages |
