    ...
    <div className="bg-slate-900 text-slate-300 min-h-screen font-inter selection:bg-indigo-500/20">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 max-w-4xl">
        ...
        <div className="space-y-8 text-slate-300">
          <p>
            This Cookie Policy explains how ReplyBase (&quot;we,&quot;
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-2 text-slate-400">
              <li>
                To provide essential functionality (e.g., authentication,
                security).
              </li>
              <li>To remember your preferences and settings.</li>
              <li>
                To understand how you use our website and improve your
                experience.
              </li>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-400">
                  ...
                  (such as your username or language) and provide enhanced, more
                  personal features.
                </p>
              </div>
              <div>
                ...
                <p className="text-slate-400">
                  ...
                  anonymously. This helps us improve our website structure and
                  content.
                </p>
              </div>
            </div>
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-2 text-slate-400">
              <li>
                See what cookies you&apos;ve got and delete them on an
                individual basis.
              </li>
            ...
            <p className="mt-4 text-slate-400">
              ...
              features of our website may not function correctly.
            </p>
          </section>
