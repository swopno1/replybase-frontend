            ...
            <main className="flex-grow flex items-center justify-center px-4 py-12">
                <div className="w-full max-w-md bg-slate-800 rounded-2xl shadow-xl border border-slate-700 p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-400">Sign in to manage your chatbots</p>
                    </div>

                    {error && (
                        <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg flex gap-3 text-red-500 text-sm">
