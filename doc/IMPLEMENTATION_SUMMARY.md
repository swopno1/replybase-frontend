...
1. **Subscription Redirect Fix**
   - Settings routes are now accessible without forcing users to pricing.

2. **Documentation Consolidation**
   - Core docs indexed and organized.
   - Subscription features and roadmap captured.

3. **Account & Billing Pages**
   - Account settings, billing, and subscription management are active.

4. **Settings Finalization**
   - Completed UI for security, notifications, privacy, and preferences.
...
- Bot management with Typebot engine integration
- Conversation intelligence and CRM views
...
- Email notifications for leads and conversations
